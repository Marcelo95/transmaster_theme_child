<?php
	...
	*/
	...
	$nt_amaze_quote_text 		= rwmb_meta('nt_amaze_quote_text', 			'type=textarea');
	$nt_amaze_quote_author 		= rwmb_meta('nt_amaze_quote_author', 		'type=text');
	$nt_amaze_color 			= rwmb_meta('nt_amaze_quote_bg', 			'type=color');
	$nt_amaze_opacity 			= rwmb_meta('nt_amaze_quote_bg_opacity', 	'type=slider');
	$nt_amaze_opacity 			= $nt_amaze_opacity / 100;

	$nt_amaze_show_quote_post_heading 	= rwmb_meta('nt_amaze_show_quote_post_heading', 'type=select');
	$nt_amaze_show_quote_post_content 	= rwmb_meta('nt_amaze_show_quote_post_content', 'type=select');
	$nt_amaze_show_quote_meta 			= rwmb_meta('nt_amaze_show_quote_meta', 		'type=select');
	$nt_amaze_show_quote_social_icons 	= rwmb_meta('nt_amaze_show_quote_social_icons', 'type=select');
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-sm-6 margin-b-30 masonry-post'); ?>>
	<div class="post-quote post-bordered">
...
<?php endif; ?>
				...
				<div class="ql_wrapper">
					<div class="entry-media" <?php if( has_post_thumbnail() ) : ?> style="background-image: url(<?php echo esc_url( $nt_amaze_image_url[0] ); ?>);" <?php endif; ?>>
						...
						<div class="ql_textwrap">
							<h3><a href="<?php the_permalink(); ?>"><?php echo esc_attr( $nt_amaze_quote_text ); ?></a></h3>
							<p><a href="<?php the_permalink(); ?>" target="_blank" style="color: #ffffff;"><?php echo esc_attr( $nt_amaze_quote_author ); ?></a></p>
						</div>
					</div>
					<div class="clear"></div>
				</div>
		...
		<div class="post-content">
			...
			<?php if( $nt_amaze_show_quote_post_heading == 'value1' || $nt_amaze_show_quote_post_heading == '' ) : ?>
				<?php
					if ( ! is_single() ) :
			...
			<?php if( $nt_amaze_show_quote_post_content == 'value1' || $nt_amaze_show_quote_post_content == '' ) : ?>
			<?php
			...
			<?php if( $nt_amaze_show_quote_meta == 'value1' || $nt_amaze_show_quote_meta == '' ) : ?>
			<hr>
			...
			<?php if( $nt_amaze_show_quote_social_icons == 'value1' || $nt_amaze_show_quote_social_icons == '' ) : ?>
