...
function my_form_search($language = "pt-BR")
{
    ...
    <form style="display: none;" role="search" method="get" class="search-form" action="<?php echo home_url('/'); ?>">
        ...
        <label>
            <input type="search" class="wp-block-search__input " placeholder="<?php echo esc_attr_x('Digite aqui …', 'placeholder') ?>" value="<?php echo get_search_query() ?>" name="s" title="<?php echo esc_attr_x('Search for:', 'label') ?>" />
        </label>
